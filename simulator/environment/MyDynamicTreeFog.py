...
class MyFog:
    ...
    def generateHosts(self):
        ...
        # Cloud
        IPS = self.types["cloud"]["IPS"]
        Ram = RAM(
            self.types["cloud"]["RAMSize"],
            self.types["cloud"]["RAMRead"],
            self.types["cloud"]["RAMWrite"],
        )
        Disk = Disk(
            self.types["cloud"]["DiskSize"],
            self.types["cloud"]["DiskRead"],
            self.types["cloud"]["DiskWrite"],
        )
        ...
        for i in range(self.num_hosts):
            ...
            hosts.append((IPS, Ram, Disk, Bw, Latency, typeID, parent, replica))
        return hosts
